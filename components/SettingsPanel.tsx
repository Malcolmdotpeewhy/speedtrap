...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
    ...
    // Handle sync success timer safely
    useEffect(() => {
                                             ...
                                             {!isGoogleSignedIn ? (
                                                 ...
                                                 <div className="space-y-3">
                                                     ...
                                                     <button
                                                        ...
                                                        disabled={isSyncing}
                                                        className={`w-full text-white font-bold py-3 rounded-lg flex items-center justify-center gap-2 min-h-[44px] transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
