                        ...
                        <div className="p-4 bg-slate-800/50 rounded-xl space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-0 top-0 bottom-0 px-3 flex items-center justify-center text-slate-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-r-lg min-w-[44px] min-h-[44px]"
                                ...
                                <div className="p-4 bg-slate-800 rounded-xl space-y-4">
                                     <div className="flex items-center justify-between">
                                        ...
                                        <Toggle
                                            ...
                                            ariaLabel="Toggle Google Drive Sync"
                                        />
                                     </div>
                                             ...
                                             {!isGoogleSignedIn ? (
                                                 ...
                                                 <div className="space-y-3">
                                                     ...
                                                     <button
                                                        ...
                                                        disabled={isSyncing}
                                                        className={`w-full font-bold py-3 rounded-lg flex items-center justify-center gap-2 min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors ${
                                                            syncState === 'success' ? 'bg-emerald-600 hover:bg-emerald-500 text-white' : 'bg-blue-600 hover:bg-blue-500 text-white disabled:opacity-50'
                                                        }`}
                                                     >
                                                         {isSyncing ? (
                                                             <>
